    ...
    try {
        ...
        foreach ($rows as $row) {
            ...
            for ($i =1; $i <= 10; $i++){
                ...
                $vals[$i]['r']['min'] = $rval-50;
                $vals[$i]['r']['max'] = $rval+50;
                $vals[$i]['g']['min'] = $gval-50;
                $vals[$i]['g']['max'] = $gval+50;
                $vals[$i]['b']['min'] = $bval-50;
                $vals[$i]['b']['max'] = $bval+50;
...
function threatImageByCo()
{
    ...
    try {
        ...
        foreach ($rows as $row) {
            ...
            $ret = findByPixelsSize($row->i_autocode, $row->i_width, $row->i_height);
